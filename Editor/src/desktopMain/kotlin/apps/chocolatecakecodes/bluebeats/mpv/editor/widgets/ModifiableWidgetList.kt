...
@Composable
internal fun <T> ModifiableWidgetList(
    values: SnapshotStateList<T>,
    newItemFactory: suspend () -> T?,
    itemWidget: @Composable (T, Int, Modifier) -> Unit,
) {
    ...
    Column(
        ...
        values.forEachIndexed { idx, item ->
            Row(verticalAlignment = Alignment.CenterVertically) {
                itemWidget(item, idx, Modifier.padding(end = 12.dp).weight(1.0f))
                IconButton(
